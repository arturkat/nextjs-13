  ...
  return (
    <main className="container prose prose-xl">
      ...
      <p>
        ...
        architecto atque aut consequatur consequuntur corporis dolor dolorem
        eaque eligendi fugit incidunt, ipsa labore modi optio, quibusdam quidem
        saepe sapiente sunt temporibus tenetur unde ut voluptas. Aliquid
        aspernatur blanditiis dolorem ducimus excepturi illum magnam nobis porro
        soluta vitae? Adipisci architecto asperiores cumque cupiditate, debitis
        dolorum ea eaque fuga fugit illo ipsam nemo neque odio quidem quod saepe
        tempore ullam veritatis vitae voluptate. A, aliquid doloribus
        exercitationem expedita, illum ipsum odio praesentium quo ratione rerum
        sequi tempora. Cum laudantium nostrum placeat quod rem. Accusantium
        alias aperiam aspernatur at autem cumque dignissimos error eveniet
        excepturi exercitationem facilis fugiat in laborum laudantium magni
        maiores minima molestias nesciunt nobis nulla pariatur perferendis
        perspiciatis, quam quasi qui quo recusandae saepe sapiente suscipit
        velit vero voluptatem voluptates voluptatibus. Ab alias aliquam
        aspernatur at deserunt dicta ducimus eaque expedita illum incidunt ipsa
        libero molestiae molestias nihil non numquam odio placeat possimus
        praesentium quasi rerum sequi ullam veniam voluptate, voluptatibus. A
        adipisci animi, architecto asperiores ducimus eum facilis ipsa possimus
        quae rem repellendus sed vitae, voluptate. Blanditiis consectetur, cum
        cupiditate dolorem hic impedit iusto magnam minima minus, mollitia
        necessitatibus nostrum omnis, optio qui recusandae repellat tenetur vel
        voluptatum!
      </p>
    </main>
  );
...
//     <>
//       <NavbarOffset />
//       <div className="bg-gray-50 py-8 flex flex-col justify-center relative overflow-hidden lg:py-12">
//         <img
//           src="/img/beams.jpg"
//           alt=""
